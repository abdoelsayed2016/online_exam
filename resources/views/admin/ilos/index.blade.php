                  ...
                  @endif
                    ...
                    <div class="editable-responsive ">
                        ...
                        <table class="table table-striped" id="faculty">
                            ...
                            <tbody>
                            @foreach($ilos as $k=>$ilo)
                                <tr class="gradeX">
                                    <th>{{$ilo->course->COURSE_NAME}}</th>
                                    <th> {{$ilo->ILO_TEXT}}</th>
                                    <th>{{$ilo->ilosType->ILO_TYPE_DESCR}}</th>
                                    <th class="actions">

                                        <a href="#" class="on-default " data-toggle="modal"
                                           data-target="#con-close-modal_{{$ilo->id}}">
                                            <i style="color: white;padding: 8px 10px;background-color: #10c469 !important;border: 1px solid #10c469 !important;
" class="fa fa-pencil"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#dialog_{{$ilo->id}}"
                                           class="on-default ">
                                    ...
                                    @include('admin.ilos.edit')
                                    <?php
                                    $route=route('ilos.destroy', $ilo->id);
                                    $id= $ilo->id;
